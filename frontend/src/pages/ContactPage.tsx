...
export default function ContactPage() {
  ...
  return (
    <>
      <Box sx={{ pt: { xs: 14, md: 18 }, pb: { xs: 10, md: 14 }, backgroundColor: palette.background.warm, textAlign: 'center', position: 'relative', overflow: 'hidden' }}>
        {/* 背景画像 */}
        <Box
          sx={{
            position: 'absolute',
            inset: 0,
            backgroundImage: 'url(/images/smile-consultation.png)',
