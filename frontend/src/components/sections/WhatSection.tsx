...
const services = [
  {
    ...
    title: '個別伴走サポート',
    sub: '体質改善プラン',
    text: '一人ひとりの体質や生活習慣に合わせ、検査データと科学的根拠をもとに体質改善をサポート。「自分で体調を整えられる身体」を目指します。',
  },
  {
    num: '02',
    title: 'ファスティング指導',
    sub: 'オプティマムファスティング',
    text: '栄養学に基づいた安全なファスティングプログラム。筋肉量をできるだけ維持しながら、効率よく脂肪を落とすことを目的としています。',
  },
  {
    num: '03',
    title: 'セミナー・講師活動',
    sub: '予防医学セミナー',
    text: '予防医学の考え方を、研究者ならではの視点で分かりやすく伝えるセミナーや講演。のべ200名以上の登壇実績があります。',
  },
];
      ...
      <Container sx={{ position: 'relative', zIndex: 1 }}>
        ...
        >
          ...
          <motion.div variants={fadeInUp}>
            ...
            >
              症状ではなく「最高の状態」を診る。あなたの身体に合ったものだけを、理由とともに。
            </Typography>
          </motion.div>
